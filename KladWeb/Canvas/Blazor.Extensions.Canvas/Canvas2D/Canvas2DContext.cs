...
namespace Blazor.Extensions.Canvas.Canvas2D
{
    public class Canvas2DContext : RenderingContext
    {
        ...
        private const string GLOBAL_COMPOSITE_OPERATION = "globalCompositeOperation";
        ...
        public async Task SetGlobalCompositeOperation(string operation)
        {
            this.GlobalCompositeOperation = operation;
            await this.BatchCallAsync(GLOBAL_COMPOSITE_OPERATION, isMethodCall: false, operation);
        }
